...
@Component({
  selector: 'app-menu-articulos-articulo',
  templateUrl: './menu-articulos-articulo.component.html',
  styleUrls: ['./menu-articulos-articulo.component.css'],
})
export class MenuArticulosArticuloComponent  implements OnInit {
