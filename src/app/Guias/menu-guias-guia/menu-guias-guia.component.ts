...
@Component({
  selector: 'app-menu-guias-guia',
  templateUrl: './menu-guias-guia.component.html',
  styleUrls: ['./menu-guias-guia.component.css'],
})
export class MenuGuiasGuiaComponent  implements OnInit {
